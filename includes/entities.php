...
return [
    ...
    'predmety' => [
        ...
        'fields' => [
            ...
            ['name' => 'zraneni', 'label' => 'Zranění', 'type' => 'number', 'quick' => true],
            ['name' => 'oc', 'label' => 'Obrana (OČ)', 'type' => 'number', 'quick' => true],
            ['name' => 'popis', 'label' => 'Popis', 'type' => 'textarea', 'quick' => true],
    ...
    'rasy' => [
        ...
        'fields' => [
            ['name' => 'nazev', 'label' => 'Název', 'type' => 'text', 'required' => true, 'quick' => true],
            ['name' => 'pohyblivost_zaklad', 'label' => 'Pohyblivost — základ (finální = tohle + oprava za OBR)', 'type' => 'number', 'quick' => true],
            ['name' => 'popis', 'label' => 'Popis', 'type' => 'textarea', 'quick' => true],
